...
if ($row9[cnt] == 0) {
	...
	$t_full_11 = $row[brand]." ".$row[hair_type]."- ".$row[item_name]." ".$row[fiber]." ".$row[length]." length ".$row[hair_type];
...
//	       13(Manufacturer)
//--------------------------------------------------------------------
$t_full_05 = str_replace("Motown Tress", "Motown", $t_full_05);
$t_full_05 = str_replace("Lace Front", "Lace Wig", $t_full_05);
