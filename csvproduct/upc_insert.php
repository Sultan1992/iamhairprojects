...
$sql = "SELECT * FROM  cscart_products 
		where status in ('A','H') and product_id between $product_sid and $product_eid";
$result = mysql_query($sql);
while ($row = mysql_fetch_assoc($result)) {

$sql = "SELECT count(*) as cnt FROM  tmp_product_upc where product_id = $row[product_id]";
