...
// tmp_product_upc
	...
	$sql1 = "insert into cscart_product_options_descriptions (option_id,option_name,comment) values 
...
// cscart_product_option_variants--2
	...
	for($i=0;$i< sizeof($arraycolor);$i++){
		...
		$sql1 = "insert into cscart_product_option_variants (variant_id,option_id,position) values ($option_variant_id,$option_max_id+1,$pos)";
		$result1 = mysql_query($sql1);
// cscart_product_option_variants_descriptions
		$sql1 = "insert into cscart_product_option_variants_descriptions
            	    (variant_id,variant_name) values ($option_variant_id,'$coltxt')";
