...
if ($row9[cnt] == 0) {
	...
	$t_full_05 = $row[brand]." ".$row[detail_logo];
	$t_full_05 = rtrim($t_full_05);
	$t_full_06 = $row[item_name]." - ".$row[detail_logo];
	...
	$t_meta_keywords = $row[item_name].",".$row[hair_type].",".$t_brand.",".$row[item_code].",".$row[featured_brand_name].",".
	...
	$t_search_words = $row[item_name].",".$row[hair_type].",".$t_brand.",".$row[item_code].",".$row[featured_brand_name].",".
		$t_page_title.",".$row[pattern]." ".$row[length]." Length";
...
$lace = str_replace("Lace Front","Lace Front Wig",$row[hair_type]);
$t_features_type_id = call_variant($lace);
