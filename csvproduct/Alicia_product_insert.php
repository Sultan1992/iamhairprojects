...
if ($row9[cnt] == 0) {
	...
	$sql2 = "SELECT * FROM  tmp_products_description
                where brand = 'Alicia' and site_gubun = '0'";
	...
	$t_full_description = str_replace("##4", $t_full_04, $t_full_description);
...
$t_features_manufacturer_id = call_variant('Alicia Beauty');
