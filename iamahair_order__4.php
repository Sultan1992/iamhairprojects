...
<table border="0" width="100%" height="5"><div align=left>
<select name="gbn">
	<option value="" <?if ($_GET['gbn'] == ""){echo "selected";}?>>::::ALL::::</option>
	<option value="BESHE" <?if ($_GET['gbn'] == "BESHE"){echo "selected";}?>>BESHE</option>
	<option value="BOBBIBOSS" <?if ($_GET['gbn'] == "BOBBIBOSS"){echo "selected";}?>>BOBBIBOSS</option>
	<option value="CHADE" <?if ($_GET['gbn'] == "CHADE"){echo "selected";}?>>CHADE</option>
	<option value="DIANA" <?if ($_GET['gbn'] == "DIANA"){echo "selected";}?>>DIANA</option>
	<option value="FOXYSILVER" <?if ($_GET['gbn'] == "FOXYSILVER"){echo "selected";}?>>FOXYSILVER</option>
	<option value="FOXYLADY" <?if ($_GET['gbn'] == "FOXYLADY"){echo "selected";}?>>FOXYLADY</option>
	<option value="CAREFREE" <?if ($_GET['gbn'] == "CAREFREE"){echo "selected";}?>>CAREFREE</option>
	<option value="OUTRE" <?if ($_GET['gbn'] == "OUTRE"){echo "selected";}?>>OUTRE</option>
	<option value="ESTETICA" <?if ($_GET['gbn'] == "ESTETICA"){echo "selected";}?>>ESTETICA</option>
	<option value="ITSAWIG" <?if ($_GET['gbn'] == "ITSAWIG"){echo "selected";}?>>ITSAWIG</option>
	<option value="HZ" <?if ($_GET['gbn'] == "HZ"){echo "selected";}?>>HZ</option>
	<option value="MOTOWN" <?if ($_GET['gbn'] == "MOTOWN"){echo "selected";}?>>MOTOWN</option>
	<option value="MODELMODEL" <?if ($_GET['gbn'] == "MODELMODEL"){echo "selected";}?>>MODELMODEL</option>
	<option value="THEWIG" <?if ($_GET['company'] == "THEWIG"){echo "selected";}?>>THEWIG</option>
	<option value="VANESSA" <?if ($_GET['company'] == "VANESSA"){echo "selected";}?>>VANESSA</option>
	<option value="VIVICAFOX" <?if ($_GET['company'] == "VIVICAFOX"){echo "selected";}?>>VIVICAFOX</option>
</select>
...
$sql = "SELECT *,DATE_FORMAT(from_unixtime(timestamp),'%m/%d/%Y') as timestamp  FROM  `cscart_orders` as a
	JOIN cscart_order_details as b on a.order_id = b.order_id
        where a.status in ('P','B','A','H') and  upper(product_code) like 
        '%$gbn%' order by b.product_code asc";
}
