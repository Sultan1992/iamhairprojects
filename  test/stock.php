...
$sql= "SELECT Product_code,variant_name,amount,qty_c,qty_p1,qty_p3
FROM  cscart_products p INNER JOIN cscart_product_options po ON p.product_id=po.product_id
...
<table border='1' width='800'border-color='#f3f3f3' cellspacing='0'>
  <tr>
    <th height='16' align='center'bgcolor='#F4f4f4'>INV#</th>
    <th height='16' align='center' bgcolor='#F4f4f4'>OrderDate</th>
    <th height='16'align='center'bgcolor='#F4f4f4'>Product code</th>
    <th height='16' align='enter' bgcolor='#F4f4f4'>Option</th>
  <th height='16' align='center' bgcolor='#F4f4f4'>Order Qty</th>
