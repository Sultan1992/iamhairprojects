...
<div class="w3-teal">
  ...
  <div class="w3-container">
    <h1>POS Inventory as 07/12/2018</h1>
  </div>
</div>
<!--
<div class="w3-container">
...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/scroller/1.5.1/js/dataTables.scroller.min.js"></script>
...
$sql="SELECT * FROM pos_inventory limit 2";
$result = $con->query($sql);
    while($row = $result->fetch_assoc()) {
  $rows []= array(
    'p_itmname' => $row['p_itmname'],
    'p_upc' => $row['p_upc'],
    'p_qty' => $row['p_qty'],
    'p_qty' => $row['p_qty'],
    'p_qty' => $row['p_qty'],
...
<div class="container">
        ...
        <tbody>
        	<?php
        	/*
$sql="SELECT * FROM pos_inventory limit 0";
$result = $con->query($sql);
